...
<header class="p-5 flex gap-2 justify-between">
    <a class="bg-orange-500 rounded-xl hover:bg-orange-600 p-2 text-white drop-shadow-lg" href="#">Agregar</a>
...
<main class="p-5">
    <div class="bg-white drop-shadow-lg rounded-lg p-2 w-[15%] flex flex-col items-center">
        ...
        <h1 class="text-base">Nombre del producto</h1>
        <strong class="text-sm">Stock: 5</strong>
