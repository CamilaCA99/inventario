                ...
                <form class="w-full" action="{{route('login.store')}}" method="POST">
                    ...
                    <main class="grid gap-3">
                        <div class="flex flex-col">
                            ...
                            <input class="p-2 border-4 border-gray-300 border-l-orange-500" type="email" name="email" id="email" placeholder="Ingresa tu correo de registro">
                            
                        </div>
                        <div class="flex flex-col">
                            <label class="font-bold" for="password">Password</label>
                            <input class="p-2 border-4 border-gray-300 border-l-orange-500" type="password" name="password" id="password" placeholder="Ingresa tu password de registro">
                        </div>
